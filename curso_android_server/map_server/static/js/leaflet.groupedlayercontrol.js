...
var name = obj.name;
    ...
    name2.innerHTML = 'Servers Unhacked<br>';

    

 var name4 = document.createElement('span');
    name4.innerHTML = 'User Created<br>';

 var name5 = document.createElement('span');
    name5.innerHTML = "Server Size<br>";
    
     if(name=='All Hacked'){
     
      name=name.substring(0, 3);
     }
     if(name=='Normal Unhacked'){
    ...
    if(name=='Premium Unhacked'){
      label.appendChild(name2);
      name=name.substring(0, 7);
    }else if(name=='Yes'){
     label.appendChild(name4);
   }else if(name=='Full'){
    label.appendChild(name5);
   }
